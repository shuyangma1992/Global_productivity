...
f_global <- ggplot(filter(productivity_summary, ESM == "IPSL-CM6A-LR")) +
...
ggsave("Figures/GLMM_projection.PDF",device = cairo_pdf,width = 9,height = 6)
