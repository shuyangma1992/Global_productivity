...
# This is used to correct priors when the data have been corrected/cleaned

# stock data
stock_data <- read_rds("Data/stocks_data_for_JABBA.rds")

# stock information
stock_information <- read_rds("Data/stocks_data_for_JABBA.rds") %>%
