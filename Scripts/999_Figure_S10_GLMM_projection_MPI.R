...
f_global <- ggplot(filter(productivity_summary, ESM == "MPI-ESM1-2-LR")) +
...
ggsave("Figures/GLMM_projection_MPI.PDF",device = cairo_pdf,width = 9,height = 6)
