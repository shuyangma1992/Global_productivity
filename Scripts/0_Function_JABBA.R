...
# 0 JABBA function 2000 iterations, for preliminary run only ---------------------------------------
# stocks time series
...
# function code
function_JABBA_2000 <- function(stock_id, seed, stocks_time_series, prior_r, prior_K, prior_psi) {
  #-----------------------------------------------------------------------1 data
  ...
  # Schaefer
  # seed=1
  jbinput_Schaefer <- build_jabba(
    catch = catch, cpue = cpue, se = cpue_se,
  ...
  # output directory
  work_dir <- getwd()
  output_dir <- paste0(work_dir, "/Outputs/JABBA results/")
  fit_Schaefer <- fit_jabba(jbinput_Schaefer,
    save.jabba = TRUE, output.dir = output_dir,
    ni = 2000, nt = 5, nb = 1000, nc = 3, seed = seed
  )
  fit_Fox <- fit_jabba(jbinput_Fox,
    save.jabba = TRUE, output.dir = output_dir,
    ni = 2000, nt = 5, nb = 1000, nc = 3, seed = seed
  )
  fit_Pella <- fit_jabba(jbinput_Pella,
    save.jabba = TRUE, output.dir = output_dir,
    ni = 2000, nt = 5, nb = 1000, nc = 3, seed = seed
  )
...
# save function
save(function_JABBA_2000, file = "Functions/function_JABBA_iteration_2000.R")

# test
function_JABBA_2000(stock_id, seed, stocks_time_series, prior_r, prior_K, prior_psi)
...
# 1 JABBA function 20000 iterations, deprecated ---------------------------------------
#stocks time series
stocks_time_series <- read_rds("Data/stocks_data.rds")
...
#function code
function_JABBA_20000 <- function(stock_id,seed,stocks_time_series,prior_r,prior_K,prior_psi){
...
#save function
save(function_JABBA_20000,file="Functions/function_JABBA_iteration_20000.R")

#test
function_JABBA_20000(stock_id,seed,stocks_time_series,prior_r,prior_K,prior_psi)
...
# 2 JABBA function 60000 iterations, deprecated --------
#function code
...
# 3 JABBA function 100000 iterations, deprecated --------
#function code
...
# 4 JABBA function 200000 iterations --------
# function code
...
# test
function_JABBA_200000(stock_id, seed, stocks_time_series, prior_r, prior_K, prior_psi)
